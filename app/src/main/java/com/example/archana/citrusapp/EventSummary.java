...
public class EventSummary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mText.setText(CreateEventActivity.events.get(CreateEventActivity.events.size() - 1).title);

        TextView mText2 = (TextView) findViewById(R.id.dateimported);
        mText2.setTextSize(30);
        mText2.setText(CreateEventActivity.events.get(CreateEventActivity.events.size() - 1).date);

        TextView mText3 = (TextView) findViewById(R.id.timeimported);
        mText3.setTextSize(30);
        mText3.setText(CreateEventActivity.events.get(CreateEventActivity.events.size() - 1).time);

        TextView mText4 = (TextView) findViewById(R.id.locationimported);
        mText4.setTextSize(30);
        mText4.setText(CreateEventActivity.events.get(CreateEventActivity.events.size() - 1).location);

        TextView mText5 = (TextView) findViewById(R.id.descriptionimported);
        mText5.setTextSize(30);
        mText5.setText(CreateEventActivity.events.get(CreateEventActivity.events.size() - 1).description);
        ...
        View.OnClickListener oclBtnOk = new View.OnClickListener()
        {
            public void onClick(View v)
            {
                ...
                Intent intent = new Intent(EventSummary.this, EventActivity.class);
